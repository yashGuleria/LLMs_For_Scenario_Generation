...
def process_question(question: str, vector_db: Chroma, selected_model: str) -> str:
    ...
    llm = ChatCohere(cohere_api_key='ENTER YOUR API-KEY',
    ...
    #     1. Interpret coordinates in the format '033014.00N' and '1054818.00E' as numeric Degrees, Minutes, Seconds (DMS) and understand their geometric position.
    #     For latitude: The last character ('N' or 'S') indicates whether the point is located north ('N') or south ('S') of the Equator.
    #     For longitude: The last character ('E' or 'W') indicates whether the point is located east ('E') or west ('W') of the Prime Meridian.

    #     2. Break down the numeric format to conventional DMS as follows:
    #     - For latitude readings, the first 2 digits represent degrees, while for longitude readings, the first 3 digits represent degrees.
    #     - The next 2 digits represent minutes.
    #     - The remaining digits before the directional letter represent seconds. Hence '033014.00N' and '1054818.00E' will become "03 degrees 30 minutes 14.00 seconds North" and " 105 degrees 48 minutes and 18.00 seconds East" respectively.

    #     3. Convert DMS to Decimal Degrees (DD).

    #     4. Determine the hemisphere: 'N' for north, 'S' for south, 'E' for east, 'W' for west.

    #     5. Calculate the relative difference in latitude and longitude between coordinates, make sure to take the positive and negative signs into account, where,
    #     - Positive ΔLatitude means the first point is north of the second.
    #     - Negative ΔLatitude means the first point is south of the second.
    #     - Positive ΔLongitude means the first point is east of the second.
    #     - Negative ΔLongitude means the first point is west of the second.

    #     6. Use the differences to determine the relative direction (e.g., north, south, east, west).

    #     7. Optionally, compute the distance if required.
    #    -----------------------------------------------
